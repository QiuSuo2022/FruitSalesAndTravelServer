...
(
    ...
    address             VARCHAR(255)  COMMENT '收货地址/门票类型',
    express             VARCHAR(127) COMMENT '物流信息/门票数目',
    fee                 INT(11) NULL COMMENT '实际付款金额(单位:分)',
    pay_status          SMALLINT  NOT NULL COMMENT '订单状态:待支付-0 待发货-1 待收货-2 待评价-3 已完成-4 售后-5',
...
(
    ...
    fruit_id            VARCHAR(44)  COMMENT '水果子项id',
